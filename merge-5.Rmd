...
```{r}
files <- list.files("/mnt/Citosina/amedina/ssalazar/meta/out/batch/selected", full.names = T)
files <- gtools::mixedsort(files)[-10]
data <- files %>% map(read_csv)


# files <- list.files("/mnt/Citosina/amedina/ssalazar/meta/out/DE_mix", full.names = T)
# files <- gtools::mixedsort(files)[-10]
# data <- files %>% map(read_csv)


# files2 <- list.files("/mnt/Citosina/amedina/ssalazar/meta/out/DE_mix/selected", full.names = T)
# files2 <- gtools::mixedsort(files)[-10]
# data <- files2 %>% map(read_csv)
```
...
write_csv(full_tables, file= "/mnt/Citosina/amedina/ssalazar/meta/out/batch/selected/mergedTables.csv")
# write_csv(full_tables, file= "/mnt/Citosina/amedina/ssalazar/meta/out/batch/mergedTables.csv")
```
...
```{r}
write_csv(full_tables, file= "/mnt/Citosina/amedina/ssalazar/meta/out/batch/selected/mergedTables_symbol.csv")
# write_csv(full_tables, file= "/mnt/Citosina/amedina/ssalazar/meta/out/batch/mergedTables_symbol.csv")
```

```{r}
tables <- read_csv("/mnt/Citosina/amedina/ssalazar/meta/out/batch/selected/mergedTables_symbol.csv")
# tables <- read_csv("/mnt/Citosina/amedina/ssalazar/meta/out/batch/mergedTables_symbol.csv")
tables <- tables[tables$transcript_biotype == "protein_coding", ]
write_csv(tables, file= "/mnt/Citosina/amedina/ssalazar/meta/out/batch/selected/merged_protein_coding.csv")
# write_csv(tables, file= "/mnt/Citosina/amedina/ssalazar/meta/out/batch/merged_protein_coding.csv")
```
