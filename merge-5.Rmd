...
# write_csv(full_tables, file= "/mnt/Citosina/amedina/ssalazar/meta/out/DEmix_mergedTables.csv")
```
...
# write_csv(full_tables, file= "/mnt/Citosina/amedina/ssalazar/meta/out/limma_mergedTables_symbol.csv")
...
# tables <- read_csv("/mnt/Citosina/amedina/ssalazar/meta/out/limma_mergedTables_symbol.csv")
tables <- tables[tables$transcript_biotype == "protein_coding", ]
write_csv(tables, file= "/mnt/Citosina/amedina/ssalazar/meta/out/mix2_protein_coding.csv")
```
