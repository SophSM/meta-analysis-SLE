...
# write_csv(full_tables, file= "/mnt/Citosina/amedina/ssalazar/meta/out/all_limma_mergedTables.csv")
```
...
write_csv(tables, file= "/mnt/Citosina/amedina/ssalazar/meta/out/limma_protein_coding.csv")
```
