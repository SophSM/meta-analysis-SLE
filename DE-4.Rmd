...
# DE_analysis <- readRDS("/mnt/Citosina/amedina/ssalazar/meta/out/all_dge.xz")


dge_1 <- readRDS("/mnt/Citosina/amedina/ssalazar/meta/out/dge_mix/SRP296987_dge.xz")
dge_2 <- readRDS("/mnt/Citosina/amedina/ssalazar/meta/out/dge_mix/SRP062966_dge.xz")
dge_3 <- readRDS("/mnt/Citosina/amedina/ssalazar/meta/out/dge_mix/SRP073191_dge.xz")
dge_4 <- readRDS("/mnt/Citosina/amedina/ssalazar/meta/out/dge_mix/SRP136102_dge.xz")
...
#all_limma <- readRDS("/mnt/Citosina/amedina/ssalazar/meta/out/corrected_rse.xz")
```
...
for(i in 1:length(SRA_projects)){
  ...
  DE_result <- lapply(dge_object, do_limma, rse_gene = rse)
  # renaming colnames with the SRA id
  colnames(DE_result[[1]]) <- str_c(colnames(DE_result[[1]]),"_", names(rse_curated[i]))
   # saving as csv
  write_csv(as.data.frame(DE_result[[1]]), file = str_c("/mnt/Citosina/amedina/ssalazar/meta/out/DE_limma/Table_Genes_", names(rse_curated[i]), ".csv"))
...
write_csv(as.data.frame(DE_analysis$SRP296987), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DE_mix/Table_Genes_SRP296987.csv")
...
write_csv(as.data.frame(DE_analysis$SRP062966), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DE_mix/Table_Genes_SRP062966.csv")
...
write_csv(as.data.frame(DE_analysis$SRP073191), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DE_mix/Table_Genes_SRP073191.csv")
...
write_csv(as.data.frame(DE_analysis$SRP136102), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DE_mix/Table_Genes_SRP136102.csv")
```
...
write_csv(as.data.frame(DE_analysis$SRP111941), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DE_mix/Table_Genes_SRP111941.csv")
...
write_csv(as.data.frame(DE_analysis$SRP311059), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DE_mix/Table_Genes_SRP311059.csv")
...
write_csv(as.data.frame(DE_analysis$SRP168421), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DE_mix/Table_Genes_SRP168421.csv")
...
write_csv(as.data.frame(DE_analysis$SRP322015), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DE_mix/Table_Genes_SRP322015.csv")
```


DESeq2 for all studies (06, 07, 16, 29, 32)
...
DE_analysis$SRP168421 <- DE
colnames(DE_analysis$SRP168421) <- str_c(colnames(DE_analysis$SRP168421),"_SRP168421")
write_csv(as.data.frame(DE_analysis$SRP168421), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DE_DESeq2/Table_Genes_SRP168421.csv")
# 32
DE <- do_DESeq(rse_curated$SRP322015)
DE$CI.L = DE$log2FoldChange - 1.96*DE$lfcSE
DE$CI.R = DE$log2FoldChange + 1.96*DE$lfcSE
DE_analysis$SRP322015 <- DE
colnames(DE_analysis$SRP322015) <- str_c(colnames(DE_analysis$SRP322015),"_SRP322015")
write_csv(as.data.frame(DE_analysis$SRP322015), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DE_DESeq2/Table_Genes_SRP322015.csv")

# 06 
assays(rse_curated$SRP062966)$raw_counts = NULL
assays(rse_curated$SRP062966)$counts <- as.integer(assays(rse_curated$SRP062966)$counts)
# counts <- gsub(",", "", (assays(rse_curated$SRP062966)$counts))
# counts <- as.integer(counts)
# assays(rse_curated$SRP062966, withDimnames=FALSE)$counts <- counts
DE <- do_DESeq(rse_curated$SRP062966)
DE$CI.L = DE$log2FoldChange - 1.96*DE$lfcSE
DE$CI.R = DE$log2FoldChange + 1.96*DE$lfcSE
DE_analysis$SRP062966 <- DE
colnames(DE_analysis$SRP062966) <- str_c(colnames(DE_analysis$SRP062966),"_SRP062966")
write_csv(as.data.frame(DE_analysis$SRP062966), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DE_DESeq2/Table_Genes_SRP062966.csv")

# 07
assays(rse_curated$SRP073191)$raw_counts = NULL
as.integer(assays(rse_curated$SRP073191)$counts)
DE <- do_DESeq(rse_curated$SRP073191)
DE$CI.L = DE$log2FoldChange - 1.96*DE$lfcSE
DE$CI.R = DE$log2FoldChange + 1.96*DE$lfcSE
DE_analysis$SRP073191 <- DE
colnames(DE_analysis$SRP073191) <- str_c(colnames(DE_analysis$SRP073191),"_SRP073191")
write_csv(as.data.frame(DE_analysis$SRP073191), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DE_DESeq2/Table_Genes_SRP073191.csv")

# 29
DE <- do_DESeq(rse_curated$SRP296987)
DE$CI.L = DE$log2FoldChange - 1.96*DE$lfcSE
DE$CI.R = DE$log2FoldChange + 1.96*DE$lfcSE
DE_analysis$SRP296987 <- DE
colnames(DE_analysis$SRP296987) <- str_c(colnames(DE_analysis$SRP296987),"_SRP296987")
write_csv(as.data.frame(DE_analysis$SRP296987), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DE_DESeq2/Table_Genes_SRP296987.csv")

```

Mix 5 studies 06, 29, 07, 16, 32
...
DE_analysis$SRP062966 <- DE
colnames(DE_analysis$SRP062966) <- str_c(colnames(DE_analysis$SRP062966),"_SRP062966")
write_csv(as.data.frame(DE_analysis$SRP062966), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DEmix/Table_Genes_SRP062966.csv")
...
DE_analysis$SRP296987 <- DE
colnames(DE_analysis$SRP296987) <- str_c(colnames(DE_analysis$SRP296987),"_SRP296987")
write_csv(as.data.frame(DE_analysis$SRP296987), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DEmix/Table_Genes_SRP296987.csv")
...
DE_analysis$SRP073191 <- DE
colnames(DE_analysis$SRP073191) <- str_c(colnames(DE_analysis$SRP073191),"_SRP073191")
write_csv(as.data.frame(DE_analysis$SRP073191), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DEmix/Table_Genes_SRP073191.csv")
# 16
DE<- do_DESeq(rse_curated$SRP168421)
DE$CI.L = DE$log2FoldChange - 1.96*DE$lfcSE
DE$CI.R = DE$log2FoldChange + 1.96*DE$lfcSE
DE_analysis$SRP168421 <- DE
colnames(DE_analysis$SRP168421) <- str_c(colnames(DE_analysis$SRP168421),"_SRP168421")
write_csv(as.data.frame(DE_analysis$SRP168421), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DEmix/Table_Genes_SRP168421.csv")
...
DE_analysis$SRP322015 <- DE
colnames(DE_analysis$SRP322015) <- str_c(colnames(DE_analysis$SRP322015),"_SRP322015")
write_csv(as.data.frame(DE_analysis$SRP322015), file = "/mnt/Citosina/amedina/ssalazar/meta/out/DEmix/Table_Genes_SRP322015.csv")
```
