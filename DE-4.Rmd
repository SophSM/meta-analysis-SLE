...
do_limma <- function(dge, rse_gene){
  ...
  de_results <- topTable(eb_results, coef = ncol(design), number = nrow(rse_gene), sort.by = "none")
...
Limma for SRP296987 & SRP062966

```{r}
DE_analysis$SRP296987 <- do_limma(dge_1, rse_gene = rse_curated$SRP296987)
...
DE_analysis$SRP062966 <- do_limma(dge_2, rse_gene = rse_curated$SRP062966)
...
```{r}
DE_analysis$SRP111941 <- do_DESeq(rse_curated$SRP111941)
...
DE_analysis$SRP311059 <- do_DESeq(rse_curated$SRP311059)
...
DE_analysis$SRP168421 <- do_DESeq(rse_curated$SRP168421)
...
DE_analysis$SRP322015 <- do_DESeq(rse_curated$SRP322015)
