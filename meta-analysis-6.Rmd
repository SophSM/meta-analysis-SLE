...
write_csv(as.data.frame(diffexplist), file= "/mnt/Citosina/amedina/ssalazar/meta/out/limma_diffexplist_protein_coding.csv")
```
...
```{r}
diffexplist <- read.csv("/mnt/Citosina/amedina/ssalazar/meta/out/diffexplist_protein_coding.csv")
## Vote counting approach
mv <- votecount_mv(diffexp = diffexplist,
             pcriteria = "pvalue",
  foldchangecol = "Log2FC", genenamecol = "Symbol", geneidcol = NULL,
  pvalue = 0.05, foldchange = 0, metathr = 0.01, collaps = T,
  jobname = "MetaVolcano_limma_protein", outputfolder = ".", draw = "HTML")
head(mv@metaresult, 10)
write_csv(as.data.frame(mv@metaresult), file= "/mnt/Citosina/amedina/ssalazar/meta/out/vote_counting_limma_protein_coding.csv") 
...
meta_degs_rem <- rem_mv(diffexp = diffexplist, pcriteria = "pvalue",
  ...
  cvar = TRUE, metathr = 0.01, jobname = "MetaVolcano_limma_protein",
